...
void setup () {
  ...
  song1 = minim.loadFile("//FS-052/studuser$/Gr12/o.younes1/My Documents/GitHub-20221019T165601Z-001/GitHub/final-project/Music/MusicDownload/Selena-Gomez-Cut-You-Off-(HipHopKit.com).mp3"); //able to pass absolute path, file name & extension, and URL
}//End setup
//
void draw() {
}//End draw
